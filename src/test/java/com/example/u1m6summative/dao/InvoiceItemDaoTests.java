...
//
//        Item item = new Item();
//        item.setDailyRate(new Double(999.78));
//        item.setName("Laptop");
...
//        invoice.setLateFee(new Double(65));
...
//        invoiceItem.setDiscount(new Double(50));
//        invoiceItem.setQuantity(6);
//        invoiceItem.setUnitRate(new Double(30));
...
//
//        invoiceItem.setDiscount(new Double(70));
//        invoiceItem.setQuantity(1);
//        invoiceItem.setUnitRate(new Double(10));
